...
import { useHeaderAnimation } from "../hooks/animations/components/headerAnime";
// Rest of your component code...

const Header = ({ thePlace }) => {
  const { HeaderAnimation } = useHeaderAnimation();
  const [animeHeader, setAnimeHeader] = useState(true);
  const handelheader = () => {
    setAnimeHeader(false);
  };

  return (
    <AnimatePresence mode="wait">
      <motion.div
        animate={animeHeader === false ? HeaderAnimation.inPagination : ""}
